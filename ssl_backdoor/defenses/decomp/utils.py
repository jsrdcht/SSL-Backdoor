...
oxford_pet_classes = ['abyssinian', 'american bulldog', 'american pit bull terrier', 'basset hound', 'beagle', 'bengal', 'birman', 'bombay', 'boxer', 'british shorthair', 'chihuahua', 'egyptian mau', 'english cocker spaniel', 'english setter', 'german shorthaired', 'great pyrenees', 'havanese', 'japanese chin', 'keeshond', 'leonberger', 'maine coon', 'miniature pinscher', 'newfoundland', 'persian', 'pomeranian', 'pug', 'ragdoll', 'russian blue', 'saint bernard', 'samoyed', 'scottish terrier', 'shiba inu', 'siamese', 'sphynx', 'staffordshire bull terrier', 'wheaten terrier', 'yorkshire terrier']
...
caltech101_templates = ['a photo of a {}.']
oxford_pet_templates = ['a photo of a {}, a type of pet.']

def get_classes_and_templates(dataset_name):
    if dataset_name == 'imagenet':
        return imagenet_classes, imagenet_templates
    elif dataset_name == 'caltech101':
        return caltech101_classes, caltech101_templates
    elif dataset_name == 'oxford_pets':
        return oxford_pet_classes, oxford_pet_templates
    else:
        # Default to ImageNet if unknown or throw error
        print(f"Warning: Unknown dataset {dataset_name}, using ImageNet classes.")
        return imagenet_classes, imagenet_templates

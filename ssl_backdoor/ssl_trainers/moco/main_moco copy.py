...
import ssl_trainers.moco.loader
import ssl_trainers.moco.builder
...
def main_worker(index, args):
    ...
    if args.method == 'moco':
        model = ssl_trainers.moco.builder.MoCo(
...
def create_data_loader(args):
    ...
    augmentation = [
        ...
        transforms.RandomApply([ssl_trainers.moco.loader.GaussianBlur([.1, 2.])], p=0.5),
        transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
        params['normalize'],
    ]

    composed_transforms = ssl_trainers.moco.loader.TwoCropsTransform(transforms.Compose(augmentation))

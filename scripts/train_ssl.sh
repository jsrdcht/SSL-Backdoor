...
# 指定保存目录，也可以是其他目录变量
SAVE_FOLDER_ROOT=/workspace/sync/SSL-Backdoor/results/test/byol_300epoch_test
CONFIG=/workspace/sync/SSL-Backdoor/configs/poisoning/trigger_based/corruptencoder.yaml
ATTACK_ALGORITHM=corruptencoder
METHOD=byol
